	...
	<div id="wrap">
		...
		<div id="main">
			...
			try {
				...
				Product product = new Product(pid, pname, pcolor, price, pimage, new java.util.Date(), menu, menu_detail);
			...
			<table width="800" border="0" cellspacing="10" cellpadding="1">
				...
				<tr>
					<td colspan="2">
						<div align="center">
							<a href="uploadlist.jsp"> <input type="submit" name="update"
								id="update" value="돌아가기" />
							</a>
