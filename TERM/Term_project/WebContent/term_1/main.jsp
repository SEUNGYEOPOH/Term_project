	...
	<div id="wrap">
		...
		<div id="main">
			...
			<div class="slide">
				...
				<ul>
					<li><img src="img/name1.jpg" alt="" width="1300" height="650" /></li>
					<li><img src="img/name2.jpg" alt="" width="1300" height="650" /></li>
					<li><img src="img/name3.jpg" alt="" width="1300" height="650" /></li>
				</ul>
		...
		<div id="new_arrival_title">

			<h2 align="center">NEW ARRIVALS</h2>
			<h2 align="center">업데이트 순간부터 7일동안 5-6%할인</h2>


		</div>
		<c:forEach var="product" items="<%=products%>">
			<c:if test="${product.pid <= 18}">
				<div class="ban">
					<p>
						<a href="detailpage.jsp?pid=${product.pid}"><img
							src="webimages/new_arrival/${product.pimage}" width="426"
							height="497" /></a>
					</p>
					<div class="ban_detail">
						<p align="center">${product.pname }</p>
						<br />
						<p align="center">(size M,) 봄,가을 시즌 입기 좋은 유니크한 아메카지 수트입니다.</p>
						<br />
						<h3>
							<p align="center">${product.price } won</p>
						</h3>
					</div>
			...
			<c:if test="${product.pid == 14}">
				<div class="ban">
					...
					<div class="ban_detail">
						<p align="center">${product.pname }</p>
						<br />
						<p align="center">(size L,XL) 부드러운 터치감에 핏감 너무 예쁜 스웨이드 자켓입니다.</p>
						<br />
						<h3>
							<p align="center">${product.price }won</p>
						</h3>
		...
		<c:forEach var="product" items="<%=products%>">
			<c:if test="${product.pid > 18 and product.pid<=26 }">
				<div class="ban">
					<p>
						<a href="detailpage.jsp?pid=${product.pid}"> <img
							src="webimages/best_item/${product.pimage }" width="426"
							height="497" /></a>
					</p>
					<div class="ban_detail">
						<p align="center">${product.pname }</p>
