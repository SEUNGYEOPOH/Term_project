...
<body>
	...
	<div id="main">
		<div id="admin_title">
			<div align="center">ADMIN PAGE</div>

		</div>
		<div id="admin_button">
			<p align="center">
				<input type="button" name="upload" id="upload" value="상품등록"
					onclick="location.href='insertpage.jsp'" />
			</p>
			<p align="center">
				<input type="button" name="membermanaging" id="membermanaging"
					value="회원관리" onclick="location.href='membermanagementpage.jsp'" />
			</p>
			<p align="center">
				<input type="button" name="saleview" id="saleview" value="판매내역조회"
					onclick="location.href='salelist.jsp'" />
			</p>
			<p align="center">
				<input type="button" name="listproduct" id="listproduct"
					value="상품정보" onclick="location.href='uploadlist.jsp'" />
			</p>
