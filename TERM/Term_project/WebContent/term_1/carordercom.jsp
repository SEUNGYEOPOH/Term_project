...
<div id="wrap"><div id="page_header" class="jbMenu">
  ...
  <a href="main.jsp"><img src="webimages/page_header/Logo_03.png" width="200" height="100" /></a>
  </div>
    <div id="menubar">
				<div id="menu">
					<ul>
		...
		try {
			...
			for (int i = 1; i <= pCount.intValue(); i++) {
				...
				if (cart != null) {
					...
					Product product = dao.selectById(conn, cart.getPid());
					int total = product.getPrice() * amount1;
					Order order = new Order(login, cart.getPid(), new java.util.Date(), amount1, address, "베이지", total);
					OrderDao oderDao = new OrderDao();
					oderDao.insert(conn, order);
