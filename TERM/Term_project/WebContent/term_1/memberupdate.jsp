...
<title>무제 문서</title>
<link href="memberupdate.css" rel="stylesheet" type="text/css" />
<style>
.jbFixed {
	position: fixed;
	top: 0px;
...
<div id="wrap"><div id="page_header">
  ...
  <div id="main">
    <div id="order_title">
      <div align="center"><strong>회원 정보 수정</strong></div>
   </div>
    <div id="order_box">
      <div id="box1">
    			...
    			String sns_yn = request.getParameter("sns_yn");
    			String email_yn = request.getParameter("email_yn");
			try {

				Connection conn = ConnectionProvider.getConnection();
				MemberDao dao = new MemberDao();
				Member member = new Member(login, password, mname, mtel, email, sns_yn, email_yn, new java.util.Date());
        ...
        <table width="800" border="0" cellspacing="10" cellpadding="1">
          ...
          <tr>
            <td><div align="center">고객님의 <span class="point">회원 정보 수정이 완료</span>되었습니다.</div></td>
          </tr>
          <tr>
            <td><div align="center"></div></td>
          </tr>
      ...
      <div id="buttonbox">
        <input type="button" name="orderbutton" id="orderbutton" value="프로필 조회"  onclick="location.href='profile.jsp'" />
        <input type="button" name="gomain" id="gomain" value="쇼핑 계속하기" onclick="location.href='main.jsp'" />
      </div>
