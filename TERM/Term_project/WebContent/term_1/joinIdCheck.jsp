...
Member member = dao.selectById(conn, mid);
...
%>
	...
	action속성에 값이 없으면 기본적으로 자기자신을 불러오지만 중복확인 버튼을 클릭했을때 변경되지않는다.-->
		<form id="wfr" action="joinIdCheck.jsp" method="post" name="wfr">
			ID : <input type="text" name="mid" id="mid" value="<%=mid%>">
	...
	<script type="text/javascript">
		function result() {
			...
			opener.document.fr.mid.value = document.wfr.mid.value;
