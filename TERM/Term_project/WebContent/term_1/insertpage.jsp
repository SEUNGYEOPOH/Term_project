...
<title>무제 문서</title>
<link href="insertpageLayout.css" rel="stylesheet" type="text/css" />
<style type="text/css">
...
<body>
	<div id="wrap">
		<div id="page_header" class="jbMenu">
			...
			<div id="main">
				<div id="insert_title">
					<div align="center">상품 등록</div>
				</div>
				<div class="table" id="insertban">
					<form id="form3" name="form3" method="post" action="insert.jsp" enctype="multipart/form-data">
				
					<table width="500" border="0" cellspacing="10" cellpadding="1">
						<tr>
							<td>상품명</td>
							<td>
									<label for="namefield"></label> <input type="text"
										name="pname" id="namefield" />
								</td>
						</tr>
						<tr>
							<td width="157">상품 색상</td>
							<td width="305">
									<label for="colorfield"></label> <input type="text"
										name="pcolor" id="pcolor" />
								</td>
						</tr>
						<tr>
							<td>가격</td>
							<td>
									<label for="pricefield"></label> <input type="text"
										name="price" id="pricefield" />
								</td>
						</tr>
						<tr>
							<td>상품이미지</td>
							<td>
									<label for="filefield"></label> <input type="file"
										name="pimage" id="filefield" />
								</td>
						</tr>
						<tr>
							<td>상품 카테고리</td>
							<td><label for="category"></label> <input type="text"
								name="menu" id="category" /></td>
						</tr>
						<tr>
							<td>상품 상세 카테고리</td>
							<td><label for="category_detail"></label> <input type="text"
								name="menu_detail" id="category_detail" /></td>
						</tr>
