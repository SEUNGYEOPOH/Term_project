  ...
  <div id="page_header_logo"><a href="main.jsp"><img src="webimages/page_header/Logo_03.png"
    ...
    <div id="page_right_menu">
  	...
  	<%
			...
			List<Order> ordertables = null;
			Member member = null;
			try {
				OrderDao odao = new OrderDao();
				MemberDao mdao = new MemberDao();
				ordertables = odao.selectList(conn);
  ...
  <div id="main">
    <div id="member_info">
      ...
      <div id="member_detail">
        <div id="detail_name">&lt; <%=login %> &gt;</div>
        <p>&nbsp;</p>
      
        <p>가입일 : <%=member.getReg_dt() %>   </p>
        <p><a href="memberupdateform.jsp">회원정보변경</a></p>
      </div>
      <div id="delivery_info">
        <table width="500" border="1" cellpadding="0" cellspacing="5">
          <tr>
            <td width="85" height="26"><div align="center"><strong>입금전</strong></div></td>
            <td width="148"><div align="center"><strong>배송준비중</strong></div></td>
            <td width="85"><div align="center"><strong>배송중</strong></div></td>
            <td width="139"><div align="center"><strong>배송완료</strong></div></td>
          </tr>
          <tr>
    ...
    <div id="order_detail">
      <div id="order_title"><strong>주문 내역 조회</strong></div>
      <p>&nbsp;</p>
      <div id="order_table"><table width="1000" border="1" cellpadding="1" cellspacing="10" class="order_info">
        <tr>
          <td width="516" height="42"><div align="center">상품정보</div></td>
          <td width="132"><div align="center">수량</div></td>
          <td width="134"><div align="center">배송비</div></td>
          <td width="260"><div align="center">상품금액</div></td>
        </tr>
        <c:forEach var="order" items="<%=ordertables%>">
        <tr>
          <td><div align="center">
            <div id="product_image"><img src="webimages/new_arrival/${order.pimage }" width="120" height="150" /></div>
            <div id="product_detail">${order.pname }</div>
          </div></td>
          <td><div align="center">${order.amount }</div></td>
          <td><div align="center">무료</div></td>
          <td><div align="center">${order.total_price}</div></td>
        </tr>
        </c:forEach>
      </table></div>
      <div id="buttonbox">
        <input type="button" name="profile" id="profile" value="PROFILE" onclick="location.href='profile.jsp'"/>
        <input type="button" name="board" id="board" value="MODIFY" onclick="location.href='memberupdateform.jsp'"/>
        <input type="button" name="cart" id="cart" value="CART" onclick="location.href='cartlist.jsp'"/>
      </div>
      <%
			}
		%>
