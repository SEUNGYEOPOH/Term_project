...
<div id="wrap"><div id="header_exchange">
    <div align="center">
     <div style="cursor: pointer;" onclick="location.href='returnpage.html';">-교환 반품 시 필독사항 </div>
    ...
    <div id="page_right_menu">
     <%
		...
		<jsp:setProperty property="*" name="member" />
			<%
	member.setReg_dt(new java.util.Date());
 ...
 %>
  <div id="main">
    ...
    </div> <div id="join_form">
    <form id="fr" name="fr" method="post" action="loginpage.jsp">
    <table width="500" border="0" cellspacing="10" cellpadding="1">
  <tr>
    <td colspan="2"><div align="center"><strong>저희 쇼핑몰을 이용해주셔서 감사합니다.</strong></div></td>
    </tr>
  <tr>
    <td width="136"><div align="center">아이디</div></td>
    <td width="330"><div align="center">${param.mid }</div></td>
  </tr>
  <tr>
    <td><div align="center">이름</div></td>
    <td><div align="center">${param.mname }</div></td>
  </tr>
  <tr>
    <td><div align="center">이메일</div></td>
    <td><div align="center">${param.email }</div></td>
  </tr>
  <tr>
