...
<div id="wrap"><div id="header_exchange">
  ...
  <tr>
    <td width="133"><div align="center">아이디</div></td>
    <td width="591">
  ...
  <tr>
    <td><div align="center">SNS 수신동의여부</div></td>
    <td>
      <p> ${m.sns_yn } <br />
      </p>
   </td>
  ...
  <tr>
    <td height="33"><div align="center">E-mail 수신동의여부</div></td>
    <td>
      <p> ${m.email_yn } <br />
        </p>
      </td>
...
<%} %>
        ...
        <input name="orderbutton" type="button" id="orderbutton" value="주문내역조회" onclick="location.href='mypage.jsp'"/>
