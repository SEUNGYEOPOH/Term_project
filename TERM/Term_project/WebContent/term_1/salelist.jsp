...
<title>무제 문서</title>
<link href="salelistpage.css" rel="stylesheet" type="text/css" />
<style>
.jbFixed {
	position: fixed;
	top: 0px;
  ...
  <div id="page_header_logo">
    ...
    <div id="listform">
      <table width="800" border="0" cellspacing="10" cellpadding="1">
        <tr>
          <td><div align="center">회원 아이디</div></td>
          <td><div align="center">상품 번호</div></td>
          <td><div align="center">수량</div></td>
          <td><div align="center">판매금액</div></td>
          <td><div align="center">판매시간</div></td>
        </tr>
          <c:forEach var="order" items="<%=ordertables%>">
        <tr>
          <td><div align="center">${order.mid }</div></td>
          <td><div align="center">${order.pid }</div></td>
          <td><div align="center">${order.amount }</div></td>
          <td><div align="center">${order.total_price}</div></td>
          <td><div align="center">${order.odate }</div></td>
        </tr>
        </c:forEach>
      </table>
    </div>
