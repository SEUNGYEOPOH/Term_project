...
<title>무제 문서</title>
<link href="loginpage2.css" rel="stylesheet" type="text/css" />
<style>
.jbFixed {
	position: fixed;
	top: 0px;
...
<script>
Kakao.init('d3c911513be751803f74de35a418eccc'); //발급받은 키 중 javascript키를 사용해준다.
...
function kakaoLogin() {
    Kakao.Auth.login({
      success: function (response) {
        ...
        window.location.href='main.jsp?mid=kakao'
...
<ul>
   ...
   <div id="main">
     ...
     <div id="main_image"><img src="webimages/detail_image/shirt1.jpg" width="600" height="700" /></div>
      <div id="loginbox">
      
      <form id="form_main" name="form_main" method="post" action="logincheck.jsp" onsubmit="return form_ck();">
      <table width="340" border="0" cellspacing="10" cellpadding="1">
  <tr>
    <td width="76" height="53">아이디</td>
    <td width="240"><label for="idfield"></label>
      <input type="text" name="mid" id="mid" /></td>
  </tr>
  <tr>
    <td height="48">비밀번호</td>
    <td><label for="password"></label>
      <input type="password" name="password" id="password" /></td>
  </tr>
  <tr>
    <td colspan="2"><input type="submit" name="login" id="login" value="LOGIN" />
      <a href="javascript:void(0)" onclick="kakaoLogin()"><img src="webimages/login/kakaoimage1.png" width="350" height="40"  /></a></td>
    </tr>
</table>
</form>
