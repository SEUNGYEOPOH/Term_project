...
<div id="wrap"><div id="page_header" class="jbMenu">
  ...
  <a href="main.jsp">
  <img src="webimages/page_header/Logo_03.png" width="200" height="100" /></a>
  </div>
    <div id="menubar">
				<div id="menu">
					<ul>
  ...
  <div id="main">
    <div id="listtitle">
      <div align="center">상품 등록 완료</div>
      	<%
				request.setCharacterEncoding("utf-8");
			%>
			<%
				String uploadPath = "C:/web/ws/Term_project/WebContent/term_1/insertimages";
			...
			try {
				...
				pcolor = multi.getParameter("pcolor");
				price = Integer.parseInt(multi.getParameter("price"));
				pimage = multi.getFilesystemName("pimage");
				menu = multi.getParameter("menu");
				menu_detail = multi.getParameter("menu_detail");
				Connection conn = ConnectionProvider.getConnection();
				ProductDao dao = new ProductDao();
				Product product = new Product(0, pname, pcolor, price, pimage, new java.util.Date(), menu, menu_detail);
    ...
    <div id="listform"><table width="800" border="0" cellspacing="10" cellpadding="1">
  <tr>
    <td height="87"><div align="center">상품 등록이 완료되었습니다.</div></td>
  </tr>
  <tr>
    <td><input type="submit" name="insert" id="insert" value="상품 등록하기" onclick="location.href='insertpage.jsp'"/>
      <input type="submit" name="list" id="list" value="상품 목록보기" onclick="location.href='uploadlist.jsp'"/></td>
  </tr>
</table>
